...
#include "Node/FSMGraphCompositeNode.h"
#include "GraphCNode_Jump.generated.h"

/**
 * JumpStart节点不能连接未被使用的节点？
 */
UCLASS()
class FLOWSTATEMACHINE_EDITOR_API UGraphCNode_JumpStart : public UFSMGraphCompositeNode
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class FLOWSTATEMACHINE_EDITOR_API UGraphCNode_JumpTo : public UFSMGraphCompositeNode
{
	GENERATED_BODY()
