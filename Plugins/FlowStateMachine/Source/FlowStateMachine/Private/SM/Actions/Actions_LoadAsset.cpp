...
void UActions_LoadAsset::ExecuteAction(UFSMNodeInstance* Instance)
{
    ...
    {
        UFSMNodeInstance* MyParent = GetParentNode<UFSMNodeInstance>();
...
void UActions_LoadAsset::LoadAsset(bool IsSyncLoad, bool IsPreload)
{
    ...
    else
    {
        ...
        LoadingHandle = IsPreload
                            ? AssetManager.PreloadPrimaryAssets({AssetId}, LoadBounds, false,
                                                                FStreamableDelegate::CreateLambda(LoadCallbackFunc),
                                                                FStreamableManager::DefaultAsyncLoadPriority)
                            : AssetManager.LoadPrimaryAsset(AssetId, LoadBounds,
                                                            FStreamableDelegate::CreateLambda(LoadCallbackFunc),
