...
public:
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "FSMMetaDataFunctionLibrary", meta = (HidePin = "WorldContextObject", DefaultToSelf = "WorldContextObject"))
	 ...
	 * NOTE: 编辑器模式下资产加载策略与打包后策略不同，编辑器环境下资源被加载过后不会释放，除非重启编辑器
	 */
	UFUNCTION(BlueprintPure, Category = "FSMMetaDataFunctionLibrary", meta = (HidePin = "WorldContextObject", DefaultToSelf = "WorldContextObject", DeterminesOutputType = "DataType"))
