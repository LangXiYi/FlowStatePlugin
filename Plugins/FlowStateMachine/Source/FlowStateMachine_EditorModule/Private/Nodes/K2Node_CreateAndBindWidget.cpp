...
void UK2Node_CreateAndBindWidget::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	static const FName Create_FunctionName = GET_FUNCTION_NAME_CHECKED(UFlowStateBFL, CreateAndBindWidget);
	...
	CallCreateNode->FunctionReference.SetExternalMember(Create_FunctionName, UFlowStateBFL::StaticClass());
