...
protected:
    ...
    virtual TSharedRef<SWidget> CreateTabBodyForObject(const FWorkflowTabSpawnInfo& Info,
                                                       UFlowStateGraph* InGraph) const override;
    virtual const FSlateBrush*
    GetTabIconForObject(const FWorkflowTabSpawnInfo& Info, UFlowStateGraph* InGraph) const override;
