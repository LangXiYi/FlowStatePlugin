...
USTRUCT()
struct FLOWSTATEEDITOR_API FFSMSchemaAction_NewNode : public FEdGraphSchemaAction
{
...
USTRUCT()
struct FLOWSTATEEDITOR_API FFSMSchemaAction_NewJumpNode : public FFSMSchemaAction_NewNode
{
    GENERATED_USTRUCT_BODY();
...
/** Action to add a subnode to the selected node */
USTRUCT()
struct FLOWSTATEEDITOR_API FFSMSchemaAction_NewSubNode : public FEdGraphSchemaAction
{
    GENERATED_USTRUCT_BODY();
