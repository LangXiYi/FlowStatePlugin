...
void FFlowStateEditorToolbar::FillModesToolbar(FToolBarBuilder& ToolbarBuilder)
{
	...
	StateMachineEditorPtr->AddToolbarWidget(
		SNew(SModeWidget, FFlowStateMachineEditor::GetLocalizedMode( FEditorHelper::FlowStateMachineMode ), FEditorHelper::FlowStateMachineMode)
	...
	StateMachineEditorPtr->AddToolbarWidget(
		SNew(SModeWidget, FFlowStateMachineEditor::GetLocalizedMode( FEditorHelper::CommonDataMode ), FEditorHelper::CommonDataMode)
		.OnGetActiveMode(GetActiveMode)
		.OnSetActiveMode(SetActiveMode)
		.CanBeSelected(StateMachineEditorPtr.Get(), &FFlowStateMachineEditor::CanAccessCommonDataMode)
