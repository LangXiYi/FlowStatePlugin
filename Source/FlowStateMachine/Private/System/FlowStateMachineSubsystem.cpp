...
bool UFlowStateMachineSubsystem::RunFlowStateMachine(UFlowStateMachine* StateMachine, FString StartNode)
{
    ...
    {
        RunningStateContext->GotoScatteredNode(StartNode);
    }
    else
    {
        RunningStateContext->GotoStateNode(RunningStateContext->GetRootState());
    }
	return true;
}
