...
public:
    ...
    virtual bool GotoScatteredNode(const FString& NodeName);
...
public:
    ...
    UFUNCTION(BlueprintPure)
    UFlowStateWidgetLayerManager* GetLayoutManager() const { return WidgetLayers; }
    ...
    UFSMRuntimeNode* GetRootState() const 
    {
        return RootState;
    }
